          ...
          <table class="maintable">
            <thead class="text-center">
                      ...
                      <th scope="col">দিন</th> 
                        ...
                        <th scope="col">প্রতি <?php echo $comission_day_interval_show; ?>তম দিনে প্রতিনিধি কমিশন  মোট মূল্যের <?php echo $reference_percentage; ?>%</th>
                      ...
                      <?php  
                        ...
                        for($i=0;$i<$how_many_comission_date;$i++){
                          ...
                          if($i>=$how_many_comission_date/2){
                            echo "<td class='reference_amount'>".(int)($reference_comission_amount/2)."/-</td>";
                          }
                          else{
                            echo "<td class='reference_amount'>".$reference_comission_amount."/-</td>";
                          }
