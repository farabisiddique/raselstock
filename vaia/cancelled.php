...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <!-- <li class="nav-item d-none d-sm-inline-block">
        <a href="./add-new-admin" class="nav-link">Add New Admin</a>
      </li> -->
    </ul>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="./cancelled.php" class="nav-link active">
...
<script type="text/javascript" charset="utf8" src="datatable/cancelled_order.js"></script>
