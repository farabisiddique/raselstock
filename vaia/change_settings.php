...
if(isset($_COOKIE["email"]))
{
      ...
      $sql = "UPDATE admin_settings SET comission_interval='$comission_day_interval_show',comission_percentage='$comission_percentage',reference_percentage='$reference_percentage',default_payment_method='$default_payment_method',main_product='$main_product',main_product_brand='$main_product_brand',packet_per_stock='$packet_per_stock',unit_price='$unit_price',amount_per_packet='$amount_per_packet' WHERE settings_id='$settings_id'";
