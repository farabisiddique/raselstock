...
$columns = array(
	...
	// 	   		$confirmButton = "<button type='button' class='btn btn-block btn-success btn-xs'><a href='confirm_order.php?id=".$d."' class='text-white'>Confirm Order</a></button>";
	...
	// 	   		return $confirmButton."<br>".$cancelButton;
...
$whereResult = " order_status='3' "; // Cancelled
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
