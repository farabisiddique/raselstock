...
$columns = array(
	...
	array( 'db' => 'id',      
		   ...
		   'formatter' => function( $d, $row ) {
		   		...
		   		$completeButton = "<button type='button' class='btn btn-block btn-success btn-xs'><a href='complete_order.php?id=".$d."' class='text-white'>Complete Order</a></button>";
		   		$cancelButton = "<button type='button' class='btn btn-block btn-danger btn-xs delete-order-trigger' data-toggle='modal' data-target='#modal-danger' data-id='".$d."'>Cancel Order</button>";
		   		...
		   		return $completeButton."<br>".$cancelButton."<br>".$printInvoiceButton;
...
$whereResult = " order_status='1' "; // Confirmed
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
